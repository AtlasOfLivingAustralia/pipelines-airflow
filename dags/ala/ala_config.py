...
NAME_MATCHING_WORKERS = int(Variable.get("name_matching_workers"))
...
SDS_ARTIFACT_URL = Variable.get("sds_artifact_url")
SDS_NEXUS_STABLE_DIRECTORY = Variable.get("sds_nexus_stable_directory")
SDS_VERSION = Variable.get("sds_version")
SDS_CONFIG_FILENAME = Variable.get("sds_config_filename")
SDS_BUCKET = Variable.get("sds_bucket")
