...
def get_dwca_steps(dataset_list):
    return [
        step_bash_cmd("a. Download data", f" /tmp/download-datasets-hdfs.sh {ala_config.S3_BUCKET_DWCA} {ala_config.S3_BUCKET_AVRO} {ala_config.EMR_JAVA_HOME} {dataset_list}"),
